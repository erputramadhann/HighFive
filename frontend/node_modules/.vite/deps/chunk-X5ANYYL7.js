import {
  ...
  require_sizing,
  require_styleq,
  require_transform_localize_style,
  require_transition,
  require_warning
} from "./chunk-ZNYOO7SA.js";
import {
  require_client
...
var import_transform_localize_style = __toESM(require_transform_localize_style());
...
var ScrollViewBase = React8.forwardRef((props, forwardedRef) => {
  ...
  var scrollState = React8.useRef({
    isScrolling: false,
    scrollLastTick: 0
  });
  var scrollTimeout = React8.useRef(null);
  var scrollRef = React8.useRef(null);
  ...
  return React8.createElement(View_default, _extends({}, rest, {
...
var ScrollView = class extends import_react5.default.Component {
  constructor() {
    super(...arguments);
  ...
  render() {
    ...
    var children = hasStickyHeaderIndices || pagingEnabled ? import_react5.default.Children.map(this.props.children, (child, i) => {
      var isSticky = hasStickyHeaderIndices && stickyHeaderIndices.indexOf(i) > -1;
      if (child != null && (isSticky || pagingEnabled)) {
        return import_react5.default.createElement(View_default, {
    ...
    var contentContainer = import_react5.default.createElement(View_default, _extends({}, contentSizeChangeProps, {
      children,
      collapsable: false,
    ...
    var scrollView = import_react5.default.createElement(ScrollViewClass, _extends({}, props, {
      ref: this._setScrollNodeRef
    }), contentContainer);
    if (refreshControl) {
      return import_react5.default.cloneElement(refreshControl, {
        style: props.style
      }, scrollView);
    }
    return scrollView;
...
var ForwardedScrollView = import_react5.default.forwardRef((props, forwardedRef) => {
  return import_react5.default.createElement(ScrollView, _extends({}, props, {
    forwardedRef
  }));
});
...
// node_modules/react-native-web/dist/exports/Image/index.js
var _excluded7 = ["aria-label", "accessibilityLabel", "blurRadius", "defaultSource", "draggable", "onError", "onLayout", "onLoad", "onLoadEnd", "onLoadStart", "pointerEvents", "source", "style"];
var ERRORED = "ERRORED";
var LOADED = "LOADED";
var LOADING = "LOADING";
var IDLE = "IDLE";
...
function createTintColorSVG(tintColor, id2) {
  return tintColor && id2 != null ? React10.createElement("svg", {
    style: {
      position: "absolute",
      height: 0,
      visibility: "hidden",
  ...
  }, React10.createElement("defs", null, React10.createElement("filter", {
    id: "tint-" + id2,
    suppressHydrationWarning: true
  }, React10.createElement("feFlood", {
    floodColor: "" + tintColor,
    key: tintColor
  }), React10.createElement("feComposite", {
    in2: "SourceAlpha",
    operator: "in"
  })))) : null;
}
...
var Image = React10.forwardRef((props, ref) => {
  ...
  var hasTextAncestor = React10.useContext(TextAncestorContext_default);
  ...
  var hiddenImage = displayImageUri ? createElement_default("img", {
    alt: ariaLabel || "",
    style: styles4.accessibilityImage$raw,
  ...
  return React10.createElement(View_default, _extends({}, rest, {
    ...
    style: [
      styles4.root,
      hasTextAncestor && styles4.inline,
      imageSizeStyle,
      style,
      styles4.undo,
  ...
  }), React10.createElement(View_default, {
    style: [styles4.image, resizeModeStyles[resizeMode], {
      backgroundImage,
      filter: filter2
    }, backgroundSize != null && {
      backgroundSize
...
var Linking = class {
  ...
  _validateURL(url) {
    (0, import_invariant3.default)(typeof url === "string", "Invalid URL: should be a string. Was: " + url);
    (0, import_invariant3.default)(url, "Invalid URL: cannot be empty");
  }
};
var open = (url, target) => {
  if (canUseDom_default) {
...
var _excluded8 = ["animating", "color", "hidesWhenStopped", "size", "style"];
var createSvgCircle = (style) => React11.createElement("circle", {
  cx: "16",
  cy: "16",
  fill: "none",
  r: "14",
...
var ActivityIndicator = React11.forwardRef((props, forwardedRef) => {
  ...
  var svg = React11.createElement("svg", {
    height: "100%",
    viewBox: "0 0 32 32",
    width: "100%"
  }, createSvgCircle({
  ...
  return React11.createElement(View_default, _extends({}, other, {
    "aria-valuemax": 1,
    "aria-valuemin": 0,
    ref: forwardedRef,
    role: "progressbar",
    style: [styles5.container, style]
  }), React11.createElement(View_default, {
    children: svg,
    style: [typeof size === "number" ? {
      height: size,
      width: size
    } : indicatorSizes[size], styles5.animation, !animating && styles5.animationPause, !animating && hidesWhenStopped && styles5.hidesWhenStopped]
  }));
});
...
// node_modules/react-native-web/dist/exports/Switch/index.js
var _excluded9 = ["aria-label", "accessibilityLabel", "activeThumbColor", "activeTrackColor", "disabled", "onValueChange", "style", "thumbColor", "trackColor", "value"];
var emptyObject10 = {};
...
var Switch = React12.forwardRef((props, forwardedRef) => {
  ...
  var rootStyle = [styles6.root, style, disabled && styles6.cursorDefault, {
    height,
    width
  }];
  ...
  var trackStyle = [styles6.track, {
    backgroundColor: disabled ? disabledTrackColor : trackCurrentColor,
    borderRadius: trackBorderRadius
  }];
  var thumbStyle = [styles6.thumb, value && styles6.thumbActive, {
  ...
  var nativeControl = createElement_default("input", {
    ...
    ref: forwardedRef,
    style: [styles6.nativeControl, styles6.cursorInherit],
    type: "checkbox",
    role: "switch"
  });
  return React12.createElement(View_default, _extends({}, other, {
    style: rootStyle
...
var TextInput = React13.forwardRef((props, forwardedRef) => {
  ...
  var dimensions2 = React13.useRef({
    height: null,
    width: null
  });
  var hostRef = React13.useRef(null);
  var prevSelection = React13.useRef(null);
  var prevSecureTextEntry = React13.useRef(false);
  React13.useEffect(() => {
  ...
  var handleContentSizeChange = React13.useCallback((hostNode) => {
  ...
  var imperativeRef = React13.useMemo(() => (hostNode) => {
    if (hostNode != null) {
  ...
  var _useLocaleContext = useLocaleContext(), contextDirection = _useLocaleContext.direction;
  var supportedProps = pickProps2(props);
  ...
  }, styles7.textinput$raw, styles7.placeholder, props.style, caretHidden && styles7.caretHidden];
    ...
    if (queue2.length) {
      ...
      try {
        if (typeof task === "object" && task.gen) {
          ...
          (0, import_invariant4.default)(typeof task === "function", "Expected Function, SimpleTask, or PromiseTask, but got:\n" + JSON.stringify(task, null, 2));
          task();
        }
      } catch (e) {
...
var InteractionManager = {
  ...
  clearInteractionHandle(handle) {
    (0, import_invariant5.default)(!!handle, "Must provide a handle to clear.");
    _scheduleUpdate();
...
var CellRenderMask = class {
  constructor(numCells) {
    (0, import_invariant6.default)(numCells >= 0, "CellRenderMask must contain a non-negative number os cells");
  ...
  addCells(cells) {
    (0, import_invariant6.default)(cells.first >= 0 && cells.first < this._numCells && cells.last >= -1 && cells.last < this._numCells && cells.last >= cells.first - 1, "CellRenderMask.addCells called with invalid cell range");
  ...
  _findRegion(cellIdx) {
    ...
    (0, import_invariant6.default)(false, "A region was not found containing cellIdx " + cellIdx);
  }
};
...
var ChildListCollection = class {
  ...
  add(list, cellKey) {
    ...
    (0, import_invariant7.default)(!this._childrenToCellKey.has(list), "Trying to add already present child list");
  ...
  remove(list) {
    ...
    (0, import_invariant7.default)(cellKey != null, "Trying to remove non-present child list");
    this._childrenToCellKey.delete(list);
    var cellLists = this._cellKeyToChildren.get(cellKey);
    (0, import_invariant7.default)(cellLists, "_cellKeyToChildren should contain cellKey");
...
var StateSafePureComponent = class extends React15.PureComponent {
  constructor(props) {
    super(props);
  ...
  _installSetStateHooks() {
    ...
    Object.defineProperty(this, "props", {
      get() {
        (0, import_invariant8.default)(!that._inAsyncStateUpdate, '"this.props" should not be accessed during state updates');
        return props;
      },
      set(newProps) {
        props = newProps;
    ...
    Object.defineProperty(this, "state", {
      get() {
        (0, import_invariant8.default)(!that._inAsyncStateUpdate, '"this.state" should not be acceessed during state updates');
        return state;
      },
      set(newState) {
        state = newState;
...
var ViewabilityHelper = class {
  ...
  computeViewableItems(props, scrollOffset, viewportHeight, getFrameMetrics, renderRange) {
    ...
    (0, import_invariant9.default)(viewablePercentThreshold != null && itemVisiblePercentThreshold != null !== (viewAreaCoveragePercentThreshold != null), "Must set exactly one of itemVisiblePercentThreshold or viewAreaCoveragePercentThreshold");
    var viewableIndices = [];
    if (itemCount === 0) {
...
var __DEV__2 = true;
var VirtualizedListContext = React16.createContext(null);
if (__DEV__2) {
...
function VirtualizedListContextProvider(_ref2) {
  ...
  return React16.createElement(VirtualizedListContext.Provider, {
    value: context
  }, children);
}
...
var CellRenderer = class extends React17.Component {
  constructor() {
    super(...arguments);
    this.state = {
      separatorProps: {
  ...
  _renderElement(renderItem, ListItemComponent, item, index) {
    ...
    if (ListItemComponent) {
      return React17.createElement(ListItemComponent, {
        item,
        index,
    ...
    (0, import_invariant10.default)(false, "VirtualizedList: Either ListItemComponent or renderItem props are required but none were found.");
  }
  render() {
    ...
    var itemSeparator = React17.isValidElement(ItemSeparatorComponent) ? (
      // $FlowFixMe[incompatible-type]
      ItemSeparatorComponent
    ) : (
      // $FlowFixMe[incompatible-type]
      ItemSeparatorComponent && React17.createElement(ItemSeparatorComponent, this.state.separatorProps)
    );
    var cellStyle = inversionStyle ? horizontal ? [styles8.rowReverse, inversionStyle] : [styles8.columnReverse, inversionStyle] : horizontal ? [styles8.row, inversionStyle] : inversionStyle;
    var result = !CellRendererComponent ? React17.createElement(View_default, _extends({
      style: cellStyle,
      onFocusCapture: onCellFocusCapture
    }, onCellLayout && {
      onLayout: this._onLayout
    }), element, itemSeparator) : React17.createElement(CellRendererComponent, _extends({
      cellKey,
      index,
      item,
      style: cellStyle,
    ...
    return React17.createElement(VirtualizedListCellContextProvider, {
...
var VirtualizedList = class _VirtualizedList extends StateSafePureComponent {
  ...
  scrollToIndex(params) {
    ...
    (0, import_invariant11.default)(index >= 0, "scrollToIndex out of range: requested index " + index + " but minimum is 0");
    (0, import_invariant11.default)(getItemCount(data) >= 1, "scrollToIndex out of range: item length " + getItemCount(data) + " but minimum is 1");
    (0, import_invariant11.default)(index < getItemCount(data), "scrollToIndex out of range: requested index " + index + " is out of 0 to " + (getItemCount(data) - 1));
    if (!getItemLayout && index > this._highestMeasuredFrameIndex) {
      (0, import_invariant11.default)(!!onScrollToIndexFailed, "scrollToIndex should be used in conjunction with getItemLayout or onScrollToIndexFailed, otherwise there is no way to know the location of offscreen indices or handle failures.");
  ...
  constructor(_props) {
    ...
    this._defaultRenderScrollComponent = (props) => {
      ...
      if (this._isNestedWithSameOrientation()) {
        return React18.createElement(View_default, props);
      } else if (onRefresh) {
        var _props$refreshing;
        (0, import_invariant11.default)(typeof props.refreshing === "boolean", "`refreshing` prop must be set as a boolean in order to use `onRefresh`, but got `" + JSON.stringify((_props$refreshing = props.refreshing) !== null && _props$refreshing !== void 0 ? _props$refreshing : "undefined") + "`");
        return (
          // $FlowFixMe[prop-missing] Invalid prop usage
          // $FlowFixMe[incompatible-use]
          React18.createElement(ScrollView_default, _extends({}, props, {
            refreshControl: props.refreshControl == null ? React18.createElement(
        ...
        return React18.createElement(ScrollView_default, props);
      }
    };
    ...
    this.__getFrameMetricsApprox = (index, props) => {
      ...
      if (frame && frame.index === index) {
        ...
        (0, import_invariant11.default)(index >= 0 && index < getItemCount(data), "Tried to get frame for out of range index " + index);
        (0, import_invariant11.default)(!getItemLayout, "Should not have to estimate frames when a measurement metrics function is provided");
        return {
  ...
  _checkProps(props) {
    ...
    (0, import_invariant11.default)(windowSizeOrDefault(windowSize) > 0, "VirtualizedList: The windowSize prop must be present and set to a value greater than 0.");
    (0, import_invariant11.default)(getItemCount, 'VirtualizedList: The "getItemCount" prop must be provided');
    var itemCount = getItemCount(data);
  ...
  static _createRenderMask(props, cellsAroundViewport, additionalRegions) {
    var itemCount = props.getItemCount(props.data);
    (0, import_invariant11.default)(cellsAroundViewport.first >= 0 && cellsAroundViewport.last >= cellsAroundViewport.first - 1 && cellsAroundViewport.last < itemCount, 'Invalid cells around viewport "[' + cellsAroundViewport.first + ", " + cellsAroundViewport.last + ']" was passed to VirtualizedList._createRenderMask');
  ...
  _adjustCellsAroundViewport(props, cellsAroundViewport) {
    ...
    if (props.disableVirtualization) {
      ...
      (0, import_invariant11.default)(newCellsAroundViewport.last < getItemCount(data), "computeWindowedRenderLimits() should return range in-bounds");
    }
  ...
  _pushCells(cells, stickyHeaderIndices, stickyIndicesFromProps, first, last, inversionStyle) {
    ...
    var _loop = function _loop2() {
      ...
      cells.push(React18.createElement(CellRenderer, _extends({
  ...
  render() {
    ...
    var inversionStyle = this.props.inverted ? horizontalOrDefault(this.props.horizontal) ? styles9.horizontallyInverted : styles9.verticallyInverted : null;
    var cells = [];
    ...
    if (ListHeaderComponent) {
      ...
      var _element = React18.isValidElement(ListHeaderComponent) ? ListHeaderComponent : (
        // $FlowFixMe[not-a-component]
        // $FlowFixMe[incompatible-type-arg]
        React18.createElement(ListHeaderComponent, null)
      );
      cells.push(React18.createElement(VirtualizedListCellContextProvider, {
    ...
    if (itemCount === 0 && ListEmptyComponent) {
      var _element2 = React18.isValidElement(ListEmptyComponent) ? ListEmptyComponent : (
        // $FlowFixMe[not-a-component]
        // $FlowFixMe[incompatible-type-arg]
        React18.createElement(ListEmptyComponent, null)
      );
      cells.push(React18.createElement(VirtualizedListCellContextProvider, {
        cellKey: this._getCellKey() + "-empty",
        key: "$empty"
      }, React18.cloneElement(_element2, {
        onLayout: (event3) => {
    ...
    if (itemCount > 0) {
      ...
      for (var _iterator = _createForOfIteratorHelperLoose(renderRegions), _step; !(_step = _iterator()).done; ) {
        ...
        if (section.isSpacer) {
          ...
          cells.push(React18.createElement(View_default, {
    ...
    if (ListFooterComponent) {
      var _element3 = React18.isValidElement(ListFooterComponent) ? ListFooterComponent : (
        // $FlowFixMe[not-a-component]
        // $FlowFixMe[incompatible-type-arg]
        React18.createElement(ListFooterComponent, null)
      );
      cells.push(React18.createElement(VirtualizedListCellContextProvider, {
    ...
    var innerRet = React18.createElement(VirtualizedListContextProvider, {
      value: {
        cellKey: null,
    ...
    }, React18.cloneElement((this.props.renderScrollComponent || this._defaultRenderScrollComponent)(scrollProps), {
      ref: this._captureScrollRef
    }, cells));
    var ret = innerRet;
    if (this.props.debug) {
      return React18.createElement(View_default, {
        style: styles9.debug
  ...
  _renderDebugOverlay() {
    ...
    return React18.createElement(View_default, {
      style: [styles9.debugOverlayBase, styles9.debugOverlay]
    }, framesInLayout.map((f, ii2) => React18.createElement(View_default, {
      key: "f" + ii2,
      style: [styles9.debugOverlayBase, styles9.debugOverlayFrame, {
        top: f.offset * normalize,
        height: f.length * normalize
      }]
    })), React18.createElement(View_default, {
      style: [styles9.debugOverlayBase, styles9.debugOverlayFrameLast, {
        top: windowTop * normalize,
        height: windowLen * normalize
      }]
    }), React18.createElement(View_default, {
      style: [styles9.debugOverlayBase, styles9.debugOverlayFrameVis, {
...
// node_modules/react-native-web/dist/vendor/react-native/FlatList/index.js
init_memoize_one_esm();
var _excluded11 = ["numColumns", "columnWrapperStyle", "removeClippedSubviews", "strictMode"];
...
var FlatList = class extends React19.PureComponent {
  /**
  ...
  constructor(_props) {
    ...
    this._keyExtractor = (items, index) => {
      ...
      if (numColumns > 1) {
        (0, import_invariant12.default)(Array.isArray(items), "FlatList: Encountered internal consistency error, expected each item to consist of an array with 1-%s columns; instead, received a single item.", numColumns);
    ...
    this._renderer = (ListItemComponent, renderItem, columnWrapperStyle, numColumns, extraData) => {
      ...
      var render2 = (props) => {
        if (ListItemComponent) {
          return React19.createElement(ListItemComponent, props);
        } else if (renderItem) {
      ...
      var renderProp = (info) => {
        if (cols > 1) {
          ...
          (0, import_invariant12.default)(Array.isArray(_item2), "Expected array of items with numColumns > 1");
          return React19.createElement(View_default, {
            style: [styles10.row, columnWrapperStyle]
          }, _item2.map((it, kk) => {
            var element = render2({
            ...
            return element != null ? React19.createElement(React19.Fragment, {
              key: kk
            }, element) : null;
          }));
        } else {
  ...
  // $FlowFixMe[missing-local-annot]
  componentDidUpdate(prevProps) {
    (0, import_invariant12.default)(prevProps.numColumns === this.props.numColumns, "Changing numColumns on the fly is not supported. Change the key prop on FlatList when changing the number of columns to force a fresh render of the component.");
    (0, import_invariant12.default)(prevProps.onViewableItemsChanged === this.props.onViewableItemsChanged, "Changing onViewableItemsChanged on the fly is not supported");
    (0, import_invariant12.default)(!deepDiffer_default(prevProps.viewabilityConfig, this.props.viewabilityConfig), "Changing viewabilityConfig on the fly is not supported");
    (0, import_invariant12.default)(prevProps.viewabilityConfigCallbackPairs === this.props.viewabilityConfigCallbackPairs, "Changing viewabilityConfigCallbackPairs on the fly is not supported");
    this._checkProps(this.props);
  }
  // $FlowFixMe[missing-local-annot]
  _checkProps(props) {
    ...
    var numColumns = numColumnsOrDefault(this.props.numColumns);
    (0, import_invariant12.default)(!getItem && !getItemCount, "FlatList does not support custom data formats.");
    if (numColumns > 1) {
      (0, import_invariant12.default)(!horizontal, "numColumns does not support horizontal.");
    } else {
      (0, import_invariant12.default)(!columnWrapperStyle, "columnWrapperStyle not supported for single column lists");
    }
    (0, import_invariant12.default)(!(onViewableItemsChanged && viewabilityConfigCallbackPairs), "FlatList does not support setting both onViewableItemsChanged and viewabilityConfigCallbackPairs.");
  }
  _pushMultiColumnViewable(arr, v) {
    ...
    v.item.forEach((item, ii) => {
      (0, import_invariant12.default)(v.index != null, "Missing index!");
  ...
  render() {
    ...
    return (
      ...
      React19.createElement(VirtualizedList_default, _extends({}, restProps, {
...
var NativeEventEmitter = class {
  constructor(nativeModule) {
    if (Platform_default.OS === "ios") {
      (0, import_invariant14.default)(nativeModule != null, "`new NativeEventEmitter()` requires a non-null argument.");
  ...
  removeAllListeners(eventType) {
    ...
    (0, import_invariant14.default)(eventType != null, "`NativeEventEmitter.removeAllListener()` requires a non-null argument.");
...
var API = {
  getValue: function getValue(tag, saveValueCallback) {
    (0, import_invariant15.default)(nativeOps, "Native animated module is not available");
...
function assertNativeAnimatedModule() {
  (0, import_invariant15.default)(NativeAnimatedModule, "Native animated module is not available");
}
...
var AnimatedNode = class {
  ...
  __getNativeTag() {
    ...
    (0, import_invariant16.default)(this.__isNative, 'Attempt to get native tag from node not marked as "native"');
...
function createInterpolation(config) {
  ...
  if (__DEV__4) {
    ...
    (0, import_invariant17.default)(inputRange.length === outputRange.length, "inputRange (" + inputRange.length + ") and outputRange (" + outputRange.length + ") must have the same length");
  }
  ...
  return (input) => {
    (0, import_invariant17.default)(typeof input === "number", "Cannot interpolation an input which is not a number");
...
function createInterpolationFromStringOutputRange(config) {
  var outputRange = config.outputRange;
  (0, import_invariant17.default)(outputRange.length >= 2, "Bad output range");
...
function checkPattern(arr) {
  ...
  for (var i = 1; i < arr.length; ++i) {
    (0, import_invariant17.default)(pattern === arr[i].replace(stringShapeRegex, ""), "invalid pattern " + arr[0] + " and " + arr[i]);
  }
}
...
function checkValidInputRange(arr) {
  (0, import_invariant17.default)(arr.length >= 2, "inputRange must have at least 2 elements");
  var message = "inputRange must be monotonically non-decreasing " + String(arr);
  for (var i = 1; i < arr.length; ++i) {
    (0, import_invariant17.default)(arr[i] >= arr[i - 1], message);
  }
}
function checkInfiniteRange(name, arr) {
  (0, import_invariant17.default)(arr.length >= 2, name + " must have at least 2 elements");
...
var AnimatedInterpolation = class _AnimatedInterpolation extends AnimatedWithChildren_default {
  ...
  __getValue() {
    ...
    (0, import_invariant17.default)(typeof parentValue === "number", "Cannot interpolate an input which is not a number.");
...
function attachNativeEvent(viewRef, eventName, argMapping) {
  ...
  (0, import_invariant18.default)(argMapping[0] && argMapping[0].nativeEvent, "Native driven events only support animated values contained inside `nativeEvent`.");
...
function validateMapping(argMapping, args) {
  var validate2 = (recMapping, recEvt, key) => {
    if (recMapping instanceof AnimatedValue_default) {
      (0, import_invariant18.default)(typeof recEvt === "number", "Bad mapping of event key " + key + ", should be number but got " + typeof recEvt);
      return;
    }
    if (typeof recEvt === "number") {
      (0, import_invariant18.default)(recMapping instanceof AnimatedValue_default, "Bad mapping of type " + typeof recMapping + " for key " + key + ", event value must map to AnimatedValue");
      return;
    }
    (0, import_invariant18.default)(typeof recMapping === "object", "Bad mapping of type " + typeof recMapping + " for key " + key);
    (0, import_invariant18.default)(typeof recEvt === "object", "Bad event of type " + typeof recEvt + " for key " + key);
    for (var mappingKey in recMapping) {
      validate2(recMapping[mappingKey], recEvt[mappingKey], mappingKey);
    }
  };
  (0, import_invariant18.default)(args.length >= argMapping.length, "Event has less arguments than mapping");
...
var AnimatedEvent = class {
  ...
  __attach(viewRef, eventName) {
    (0, import_invariant18.default)(this.__isNative, "Only native driven events need to be attached.");
    this._attachedEvent = attachNativeEvent(viewRef, eventName, this._argMapping);
  }
  __detach(viewTag, eventName) {
    (0, import_invariant18.default)(this.__isNative, "Only native driven events need to be detached.");
...
var AnimatedProps = class extends AnimatedNode_default {
  ...
  __connectAnimatedView() {
    (0, import_invariant19.default)(this.__isNative, 'Expected node to be marked as "native"');
    var nativeViewTag = this._animatedView;
    (0, import_invariant19.default)(nativeViewTag != null, "Unable to locate attached view in the native tree");
...
function createAnimatedComponent(Component3) {
  return React20.forwardRef((props, forwardedRef) => {
    ...
    var _ref = passthroughAnimatedPropExplicitValues !== null && passthroughAnimatedPropExplicitValues !== void 0 ? passthroughAnimatedPropExplicitValues : {}, passthroughStyle = _ref.style, passthroughProps = _objectWithoutPropertiesLoose(_ref, _excluded12);
    var mergedStyle = [style, passthroughStyle];
    return React20.createElement(Component3, _extends({}, reducedProps, passthroughProps, {
      style: mergedStyle,
      ref
    }));
  });
...
// node_modules/react-native-web/dist/vendor/react-native/Animated/components/AnimatedFlatList.js
var FlatListWithEventThrottle = React21.forwardRef((props, ref) => React21.createElement(FlatList_default2, _extends({
...
var ScrollViewWithEventThrottle = React23.forwardRef((props, ref) => React23.createElement(ScrollView_default, _extends({
  scrollEventThrottle: 1e-4
}, props, {
  ref
})));
...
var _excluded13 = ["ItemSeparatorComponent", "SectionSeparatorComponent", "renderItem", "renderSectionFooter", "renderSectionHeader", "sections", "stickySectionHeadersEnabled"];
var VirtualizedSectionList = class extends React24.PureComponent {
  constructor() {
    ...
    this._convertViewable = (viewable) => {
      var _info$index;
      (0, import_invariant20.default)(viewable.index != null, "Received a broken ViewToken");
    ...
    this._renderItem = (listItemCount) => (
      ...
      (_ref2) => {
        ...
        if (infoIndex == null) {
          ...
          return React24.createElement(ItemWithSeparator, {
            SeparatorComponent,
  ...
  render() {
    ...
    return React24.createElement(VirtualizedList_default, _extends({}, passThroughProps, {
      keyExtractor: this._keyExtractor,
      stickyHeaderIndices,
      renderItem,
...
function ItemWithSeparator(props) {
  ...
  var leadingSeparator = LeadingSeparatorComponent != null && React24.createElement(LeadingSeparatorComponent, _extends({
    highlighted: leadingSeparatorHiglighted
  }, leadingSeparatorProps));
  var separator = SeparatorComponent != null && React24.createElement(SeparatorComponent, _extends({
    highlighted: separatorHighlighted
  }, separatorProps));
  return leadingSeparator || separator ? React24.createElement(View_default, null, inverted === false ? leadingSeparator : separator, element, inverted === false ? separator : leadingSeparator) : element;
}
var VirtualizedSectionList_default = VirtualizedSectionList;

// node_modules/react-native-web/dist/vendor/react-native/SectionList/index.js
var _excluded14 = ["stickySectionHeadersEnabled"];
var SectionList = class extends React25.PureComponent {
  constructor() {
    super(...arguments);
    this._captureRef = (ref) => {
  ...
  render() {
    var _this$props = this.props, _stickySectionHeadersEnabled = _this$props.stickySectionHeadersEnabled, restProps = _objectWithoutPropertiesLoose(_this$props, _excluded14);
    ...
    return React25.createElement(VirtualizedSectionList_default, _extends({}, restProps, {
...
// node_modules/react-native-web/dist/vendor/react-native/Animated/components/AnimatedSectionList.js
var SectionListWithEventThrottle = React26.forwardRef((props, ref) => React26.createElement(SectionList_default, _extends({
  scrollEventThrottle: 1e-4
}, props, {
  ref
})));
...
var _excluded15 = ["hrefAttrs", "numberOfLines", "onClick", "onLayout", "onPress", "onMoveShouldSetResponder", "onMoveShouldSetResponderCapture", "onResponderEnd", "onResponderGrant", "onResponderMove", "onResponderReject", "onResponderRelease", "onResponderStart", "onResponderTerminate", "onResponderTerminationRequest", "onScrollShouldSetResponder", "onScrollShouldSetResponderCapture", "onSelectionChangeShouldSetResponder", "onSelectionChangeShouldSetResponderCapture", "onStartShouldSetResponder", "onStartShouldSetResponderCapture", "selectable"];
...
var Text = React27.forwardRef((props, forwardedRef) => {
  var hrefAttrs = props.hrefAttrs, numberOfLines = props.numberOfLines, onClick = props.onClick, onLayout = props.onLayout, onPress = props.onPress, onMoveShouldSetResponder = props.onMoveShouldSetResponder, onMoveShouldSetResponderCapture = props.onMoveShouldSetResponderCapture, onResponderEnd = props.onResponderEnd, onResponderGrant = props.onResponderGrant, onResponderMove = props.onResponderMove, onResponderReject = props.onResponderReject, onResponderRelease = props.onResponderRelease, onResponderStart = props.onResponderStart, onResponderTerminate = props.onResponderTerminate, onResponderTerminationRequest = props.onResponderTerminationRequest, onScrollShouldSetResponder = props.onScrollShouldSetResponder, onScrollShouldSetResponderCapture = props.onScrollShouldSetResponderCapture, onSelectionChangeShouldSetResponder = props.onSelectionChangeShouldSetResponder, onSelectionChangeShouldSetResponderCapture = props.onSelectionChangeShouldSetResponderCapture, onStartShouldSetResponder = props.onStartShouldSetResponder, onStartShouldSetResponderCapture = props.onStartShouldSetResponderCapture, selectable = props.selectable, rest = _objectWithoutPropertiesLoose(props, _excluded15);
  var hasTextAncestor = React27.useContext(TextAncestorContext_default);
  var hostRef = React27.useRef(null);
  var _useLocaleContext = useLocaleContext(), contextDirection = _useLocaleContext.direction;
  useElementLayout(hostRef, onLayout);
  useResponderEvents(hostRef, {
    onMoveShouldSetResponder,
  ...
  var handleClick = React27.useCallback((e) => {
    if (onClick != null) {
      onClick(e);
  ...
  var componentDirection = props.dir || langDirection;
  var writingDirection = componentDirection || contextDirection;
  var supportedProps = pickProps3(rest);
  supportedProps.dir = componentDirection;
  if (!hasTextAncestor) {
  ...
  }, hasTextAncestor === true ? styles11.textHasAncestor$raw : styles11.text$raw, numberOfLines === 1 && styles11.textOneLine, numberOfLines != null && numberOfLines > 1 && styles11.textMultiLine, props.style, selectable === true && styles11.selectable, selectable === false && styles11.notSelectable, onPress && styles11.pressable];
  if (props.href != null) {
    component = "a";
    if (hrefAttrs != null) {
      var download = hrefAttrs.download, rel = hrefAttrs.rel, target = hrefAttrs.target;
  ...
  return hasTextAncestor ? element : React27.createElement(TextAncestorContext_default.Provider, {
    value: true
  }, element);
});
...
var AnimatedValueXY = class extends AnimatedWithChildren_default {
  constructor(valueIn) {
    ...
    if (typeof value.x === "number" && typeof value.y === "number") {
      ...
      (0, import_invariant21.default)(value.x instanceof AnimatedValue_default && value.y instanceof AnimatedValue_default, "AnimatedValueXY must be initialized with an object of numbers or AnimatedValues.");
      this.x = value.x;
      this.y = value.y;
    }
    this._listeners = {};
...
var SpringAnimation = class _SpringAnimation extends Animation_default {
  constructor(config) {
    ...
    if (config.stiffness !== void 0 || config.damping !== void 0 || config.mass !== void 0) {
      ...
      (0, import_invariant22.default)(config.bounciness === void 0 && config.speed === void 0 && config.tension === void 0 && config.friction === void 0, "You can define one of bounciness/speed, tension/friction, or stiffness/damping/mass, but not more than one");
      ...
      (0, import_invariant22.default)(config.tension === void 0 && config.friction === void 0 && config.stiffness === void 0 && config.damping === void 0 && config.mass === void 0, "You can define one of bounciness/speed, tension/friction, or stiffness/damping/mass, but not more than one");
    ...
    (0, import_invariant22.default)(this._stiffness > 0, "Stiffness value must be greater than 0");
    (0, import_invariant22.default)(this._damping > 0, "Damping value must be greater than 0");
    (0, import_invariant22.default)(this._mass > 0, "Mass value must be greater than 0");
  }
  __getNativeAnimationConfig() {
...
var RootTagContext = React30.createContext(null);
var AppContainer = React30.forwardRef((props, forwardedRef) => {
  var children = props.children, WrapperComponent = props.WrapperComponent;
  var innerView = React30.createElement(View_default, {
    children,
    key: 1,
    style: styles12.appContainer
  });
  if (WrapperComponent) {
    innerView = React30.createElement(WrapperComponent, null, innerView);
  }
  return React30.createElement(RootTagContext.Provider, {
    value: props.rootTag
  }, React30.createElement(View_default, {
    ref: forwardedRef,
    style: styles12.appContainer
  }, innerView));
});
...
var AppState = class _AppState {
  ...
  static addEventListener(type, handler) {
    if (_AppState.isAvailable) {
      (0, import_invariant25.default)(EVENT_TYPES.indexOf(type) !== -1, 'Trying to subscribe to unknown event: "%s"', type);
      if (type === "change") {
        if (!changeEmitter) {
...
function TouchableOpacity(props, forwardedRef) {
  ...
  return React32.createElement(View_default, _extends({}, rest, pressEventHandlers, {
    accessibilityDisabled: disabled,
    focusable: !disabled && focusable !== false,
    pointerEvents: disabled ? "box-none" : void 0,
    ref: setRef,
    style: [styles13.root, !disabled && styles13.actionable, style, opacityOverride != null && {
...
var MemoedTouchableOpacity = React32.memo(React32.forwardRef(TouchableOpacity));
MemoedTouchableOpacity.displayName = "TouchableOpacity";
var TouchableOpacity_default = MemoedTouchableOpacity;

// node_modules/react-native-web/dist/exports/Button/index.js
var Button = React33.forwardRef((props, forwardedRef) => {
  ...
  return React33.createElement(TouchableOpacity_default, {
    accessibilityLabel,
    ...
    onPress,
    ref: forwardedRef,
    style: [styles14.button, color && {
      backgroundColor: color
    }, disabled && styles14.buttonDisabled],
    testID
  }, React33.createElement(Text_default, {
    style: [styles14.text, disabled && styles14.textDisabled]
  }, title));
});
...
var _excluded17 = ["aria-readonly", "color", "disabled", "onChange", "onValueChange", "readOnly", "style", "value"];
var CheckBox = React34.forwardRef((props, forwardedRef) => {
  var ariaReadOnly = props["aria-readonly"], color = props.color, disabled = props.disabled, onChange = props.onChange, onValueChange = props.onValueChange, readOnly = props.readOnly, style = props.style, value = props.value, other = _objectWithoutPropertiesLoose(props, _excluded17);
  function handleChange(event3) {
  ...
  var fakeControl = React34.createElement(View_default, {
    style: [
      styles15.fakeControl,
      value && styles15.fakeControlChecked,
      // custom color
      value && color && {
        backgroundColor: color,
        borderColor: color
      },
      disabled && styles15.fakeControlDisabled,
      value && disabled && styles15.fakeControlCheckedAndDisabled
    ]
  });
  var nativeControl = createElement_default("input", {
    checked: value,
    ...
    ref: forwardedRef,
    style: [styles15.nativeControl, styles15.cursorInherit],
    type: "checkbox"
  });
  return React34.createElement(View_default, _extends({}, other, {
    "aria-disabled": disabled,
    "aria-readonly": ariaReadOnly,
    style: [styles15.root, style, disabled && styles15.cursorDefault]
...
var _excluded18 = ["children", "style", "imageStyle", "imageRef"];
var emptyObject11 = {};
var ImageBackground = (0, import_react14.forwardRef)((props, forwardedRef) => {
  var children = props.children, _props$style = props.style, style = _props$style === void 0 ? emptyObject11 : _props$style, imageStyle = props.imageStyle, imageRef = props.imageRef, rest = _objectWithoutPropertiesLoose(props, _excluded18);
  ...
  return React35.createElement(View_default, {
    ref: forwardedRef,
    style
  }, React35.createElement(Image_default, _extends({}, rest, {
    ref: imageRef,
    style: [{
...
function getAnimationStyle(animationType, visible) {
  ...
  return visible ? styles16.container : styles16.hidden;
}
function ModalAnimation(props) {
  ...
  var _React$useState = React38.useState(false), isRendering = _React$useState[0], setIsRendering = _React$useState[1];
  var wasVisible = React38.useRef(false);
  var wasRendering = React38.useRef(false);
  var isAnimated = animationType && animationType !== "none";
  var animationEndCallback = React38.useCallback((e) => {
  ...
  return isRendering || visible ? createElement_default("div", {
    style: isRendering ? getAnimationStyle(animationType, visible) : styles16.hidden,
...
var animatedSlideInStyles = [styles16.container, styles16.animatedIn, styles16.slideIn];
var animatedSlideOutStyles = [styles16.container, styles16.animatedOut, styles16.slideOut];
var animatedFadeInStyles = [styles16.container, styles16.animatedIn, styles16.fadeIn];
var animatedFadeOutStyles = [styles16.container, styles16.animatedOut, styles16.fadeOut];
...
var ModalContent = React39.forwardRef((props, forwardedRef) => {
  ...
  var style = React39.useMemo(() => {
    return [styles17.modal, transparent ? styles17.modalTransparent : styles17.modalOpaque];
  }, [transparent]);
  return React39.createElement(View_default, _extends({}, rest, {
    "aria-modal": true,
    ref: forwardedRef,
    role: active ? "dialog" : null,
    style
  }), React39.createElement(View_default, {
...
var ModalFocusTrap = (_ref) => {
  ...
  var trapElementRef = React40.useRef();
  var focusRef = React40.useRef({
  ...
  return React40.createElement(React40.Fragment, null, React40.createElement(FocusBracket, null), React40.createElement(View_default, {
    ref: trapElementRef
  }, children), React40.createElement(FocusBracket, null));
};
...
var Modal = React41.forwardRef((props, forwardedRef) => {
  ...
  var modalId = React41.useMemo(() => uniqueModalIdentifier++, []);
  var _React$useState = React41.useState(false), isActive = _React$useState[0], setIsActive = _React$useState[1];
  var onDismissCallback = React41.useCallback(() => {
    removeActiveModal(modalId);
    if (onDismiss) {
      onDismiss();
    }
  }, [modalId, onDismiss]);
  var onShowCallback = React41.useCallback(() => {
  ...
  return React41.createElement(ModalPortal_default, null, React41.createElement(ModalAnimation_default, {
    animationType,
    onDismiss: onDismissCallback,
    onShow: onShowCallback,
    visible
  }, React41.createElement(ModalFocusTrap_default, {
    active: isActive
  }, React41.createElement(ModalContent_default, _extends({}, rest, {
    active: isActive,
    onRequestClose,
    ref: forwardedRef,
    transparent
...
var Picker = React42.forwardRef((props, forwardedRef) => {
  ...
  var hostRef = React42.useRef(null);
  function handleChange(e) {
...
function Pressable(props, forwardedRef) {
  ...
  var blurHandler = React43.useCallback((e) => {
  ...
  var focusHandler = React43.useCallback((e) => {
    if (e.nativeEvent.target === hostRef.current) {
      setFocused(true);
      if (onFocus != null) {
        onFocus(e);
  ...
  var contextMenuHandler = React43.useCallback((e) => {
  ...
  var keyDownHandler = React43.useCallback((e) => {
  ...
  return React43.createElement(View_default, _extends({}, rest, pressEventHandlers, {
    "aria-disabled": disabled,
    onBlur: blurHandler,
    ...
    ref: setRef,
    style: [disabled ? styles20.disabled : styles20.active, typeof style === "function" ? style(interactionState) : style],
    tabIndex: _tabIndex
...
var ProgressBar = React44.forwardRef((props, ref) => {
  ...
  return React44.createElement(View_default, _extends({}, other, {
    ...
    style: [{
      backgroundColor: color,
      width
    }, styles21.progress, indeterminate && styles21.animation]
  }));
});
...
var SafeAreaView = React45.forwardRef((props, ref) => {
  var style = props.style, rest = _objectWithoutPropertiesLoose(props, _excluded24);
  return React45.createElement(View_default, _extends({}, rest, {
    ref,
    style: [styles22.root, style]
  }));
});
...
StatusBar.setBackgroundColor = emptyFunction3;
StatusBar.setBarStyle = emptyFunction3;
StatusBar.setHidden = emptyFunction3;
StatusBar.setNetworkActivityIndicatorVisible = emptyFunction3;
StatusBar.setTranslucent = emptyFunction3;
...
var _excluded25 = ["activeOpacity", "children", "delayPressIn", "delayPressOut", "delayLongPress", "disabled", "focusable", "onHideUnderlay", "onLongPress", "onPress", "onPressIn", "onPressOut", "onShowUnderlay", "rejectResponderTermination", "style", "testOnly_pressed", "underlayColor"];
...
function UnimplementedView(_ref) {
  var style = _ref.style, props = _objectWithoutPropertiesLoose(_ref, _excluded26);
...
//# sourceMappingURL=chunk-X5ANYYL7.js.map
