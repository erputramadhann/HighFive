...
var palettes = (() => {
  const lightTransparent = "rgba(255,255,255,0)", darkTransparent = "rgba(10,10,10,0)", transparent = (hsl, opacity = 0) => hsl.replace("%)", `%, ${opacity})`).replace("hsl(", "hsla("), getColorPalette = (colors3, color2 = colors3[0]) => {
...
var objectKeys2 = (obj) => Object.keys(obj);
...
var AnimatedView = Animated_default.View;
var AnimatedText = Animated_default.Text;
function useAnimatedNumber(initial) {
  const state = import_react.default.useRef(null);
  return state.current || (state.current = {
    composite: null,
    val: new Animated_default.Value(initial),
    strategy: {
      type: "spring"
    }
  }), {
    ...
    setValue(next, {
      ...
      if (type === "direct") val.setValue(next);
        ...
        const composite = Animated_default.spring(val, {
          ...config2,
          toValue: next,
        ...
        const composite = Animated_default.timing(val, {
          ...config2,
          toValue: next,
          useNativeDriver: !isWeb
        });
...
function createAnimations(animations2) {
  return {
    ...
    useAnimations: ({
      ...
      const isDisabled = isWeb && componentState.unmounted === true, isExiting = (presence == null ? void 0 : presence[0]) === false, sendExitComplete = presence == null ? void 0 : presence[1], animateStyles = import_react.default.useRef({}), animatedTranforms = import_react.default.useRef([]), animationsState = import_react.default.useRef(/* @__PURE__ */ new WeakMap()), animateOnly = props.animateOnly || [], hasAnimateOnly = !!props.animateOnly, args = [JSON.stringify(style), componentState, isExiting, !!onDidAnimate], isThereNoNativeStyleKeys = import_react.default.useMemo(() => isWeb ? true : Object.keys(style).some((key) => animateOnly ? !animatedStyleKey[key] && animateOnly.indexOf(key) === -1 : !animatedStyleKey[key]), args), res = import_react.default.useMemo(() => {
        var _a;
        ...
        const animatedStyle = {
          ...
          transform: animatedTranforms.current.map((r2) => {
            var _a2;
            const key = Object.keys(r2)[0], val = ((_a2 = animationsState.current.get(r2[key])) == null ? void 0 : _a2.interpolation) || r2[key];
            return {
              [key]: val
            };
          })
        ...
        function update(key, animated, valIn) {
          ...
          const value = animated || new Animated_default.Value(val), curInterpolation = animationsState.current.get(value);
          let interpolateArgs;
          if (type && (interpolateArgs = getInterpolated((curInterpolation == null ? void 0 : curInterpolation.current) ?? value._value, val, type), animationsState.current.set(value, {
            ...
            completions.push(promise), runners.push(() => {
              ...
              function getAnimation() {
                return Animated_default[animationConfig.type || "spring"](value, {
                  toValue: animateToValue,
                  useNativeDriver: !isWeb && !isThereNoNativeStyleKeys,
                  ...animationConfig
                });
              }
              (animationConfig.delay ? Animated_default.sequence([Animated_default.delay(animationConfig.delay), getAnimation()]) : getAnimation()).start(({
                finished
              }) => {
                finished && resolve();
              });
          ...
          return props.debug === "verbose" && console.info(" 💠 animate", key, `from (${value._value}) to`, valIn, `(${val})`, "type", type, "interpolate", interpolateArgs), value;
        }
      }, args);
      ...
      }, args), props.debug === "verbose" && console.info("Animated", {
        response: res,
        inputStyle: style,
        isExiting
      }), res;
...
//# sourceMappingURL=@tamagui_config.js.map
