...
var Colors = __toESM(require("@tamagui/colors")), import_v4 = require("@tamagui/shorthands/v4"), import_theme_builder = require("@tamagui/theme-builder"), import_v42 = require("@tamagui/themes/v4"), import_v3_animations = require("./v3-animations"), import_v4_fonts = require("./v4-fonts"), import_v4_media = require("./v4-media"), import_v43 = require("@tamagui/shorthands/v4"), import_theme_builder2 = require("@tamagui/theme-builder"), import_v44 = require("@tamagui/themes/v4"), import_v4_animations = require("./v4-animations"), import_v4_fonts2 = require("./v4-fonts"), import_v4_media2 = require("./v4-media"), darkPalette = [
  "#050505",
  "#151515",
  "#191919",
  "#232323",
